...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.PATCH, "/api/authors/{authorNumber}").hasRole("LIBRARIAN")
                .requestMatchers(HttpMethod.GET, "/api/authors/{authorNumber}").hasAnyRole("READER", "LIBRARIAN")
                .requestMatchers(HttpMethod.GET, "/api/authors").hasAnyRole("READER", "LIBRARIAN")
                .requestMatchers(HttpMethod.GET, "/api/authors/{authorNumber}/books").hasRole("READER")
                .requestMatchers(HttpMethod.GET, "/api/authors/top5").hasRole("READER")
                .requestMatchers(HttpMethod.GET, "/api/authors/{authorNumber}/photo").hasAnyRole("READER", "LIBRARIAN")
                .requestMatchers(HttpMethod.DELETE, "/api/authors/{authorNumber}/photo").hasAnyRole("LIBRARIAN")
                .requestMatchers(HttpMethod.GET, "/api/authors/{authorNumber}/coauthors").hasRole("READER")
                //end authors
